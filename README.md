...
**Version 0.3.2** · Go 1.25 · Apache-2.0 · [Architecture invariants](docs/architecture/invariants.md) · [Threat model](docs/architecture/threat-model.md) · [Research corpus](docs/research/README.md)
