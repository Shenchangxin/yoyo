...
import type { AssetLibraryPickerFolder, AssetLibraryPickerItem } from "@yingce/components/assets/asset-library-picker-modal";
import { createHostedAssetSources, type HostedAssetSource } from "@yingce/services/external-asset-sources";
import type { ExternalAssetFolder, ExternalAssetItem, ExternalAssetPickerReference } from "@yingce/lib/plugins/plugin-types";
