// @ts-nocheck
import type { Asset, AssetKind, AssetStatus, AudioAsset, EntityAsset, ImageAsset, ModelAsset, TextAsset, VideoAsset } from "@yingce/stores/use-asset-store";
import { parseAssetCategory } from "@yingce/lib/asset-category";
