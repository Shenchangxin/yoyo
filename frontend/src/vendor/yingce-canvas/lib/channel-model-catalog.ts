// @ts-nocheck
import { defaultModelCapabilityConfig, type ModelCapabilityConfig } from "@yingce/lib/model-capabilities";
import { modelProtocolCapability, protocolForModelCatalog, type ModelProtocol } from "@yingce/lib/model-protocols";
