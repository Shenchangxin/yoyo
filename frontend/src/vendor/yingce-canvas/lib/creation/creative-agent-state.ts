// @ts-nocheck
import type { CanvasOperation, CanvasSnapshot } from "@yingce/lib/canvas/canvas-operation-contract";
import { buildCanvasWorkflowOps } from "@yingce/lib/canvas/canvas-workflow-builder";
import { modelCapabilityConfigFor } from "@yingce/lib/model-capabilities";
import { selectableModelsByCapability, type AiConfig } from "@yingce/stores/use-config-store";
import { resourceFileUrl, resourceIdFromStorageKey } from "@yingce/services/api/resources";
import type { ResponseInputMessage } from "@yingce/services/api/image";
