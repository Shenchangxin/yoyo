// @ts-nocheck
import type { ResponseFunctionTool } from "@yingce/services/api/image";
...
export const CREATIVE_AGENT_SYSTEM_PROMPT = `你是 Yoyo 的通用创作助手，支持短片、营销、电商与一般创作。普通咨询直接回答，不强制问卷、方案或任务计划。
