// @ts-nocheck
import type { ModelProtocol, ModelProtocolWorkflow } from "@yingce/lib/model-protocols";
import type { ImageResolutionOption, ImageResolutionTier } from "@yingce/lib/image-resolution-tiers";
