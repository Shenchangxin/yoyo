// @ts-nocheck
import { modelOptionName, resolveModelRequestConfig, type AiConfig } from "@yingce/stores/use-config-store";
import { normalizeVideoDuration, VIDEO_DURATION_OPTIONS } from "@yingce/lib/video-generation-options";
