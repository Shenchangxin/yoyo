// @ts-nocheck
import { requestAudioGeneration } from "@yingce/services/api/audio";
import { requestGeneration, requestImageQuestion } from "@yingce/services/api/image";
import { createVideoGenerationTask } from "@yingce/services/api/video";
import { defaultConfig, encodeChannelModel, type ModelCapability, type ModelChannel } from "@yingce/stores/use-config-store";
