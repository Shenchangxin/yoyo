// @ts-nocheck
import { defaultImageCapabilityConfig, modelCapabilityConfigFor, normalizeImageValue, normalizeVideoValue, STANDARD_IMAGE_SIZE_VALUES, videoDurationAllowed, type ImageCapabilityConfig } from "@yingce/lib/model-capabilities";
import { videoResolutionComparisonKey } from "@yingce/lib/video-generation-options";
import { imageSizePresets } from "@yingce/lib/image-size-presets";
import { modelOptionName, PUBLIC_MODEL_CATALOG_ID, resolveModelChannel, selectableModelsByCapability, type AiConfig, type ModelCapability } from "@yingce/stores/use-config-store";
