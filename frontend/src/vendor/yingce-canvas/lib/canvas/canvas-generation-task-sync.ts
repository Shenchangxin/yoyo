...
import { commitCanvasGenerationResult } from "@yingce/lib/canvas/canvas-generation-result";
import { fitNodeSize, nodeSizeFromRatio, VIDEO_NODE_MAX_SIZE } from "@yingce/lib/canvas/canvas-node-size";
import { compositeEmotionImage } from "@yingce/lib/canvas/canvas-emotion";
import { storeGeneratedAudio } from "@yingce/services/api/audio";
import { storeGeneratedVideo } from "@yingce/services/api/video";
import { parseBackendGenerationResult } from "@yingce/services/api/generation-task";
import type { GenerationTask, GenerationTaskOutput } from "@yingce/services/api/task-center";
import { resolveMediaUrl, type UploadedFile } from "@yingce/services/file-storage";
import { resolveImageUrl, uploadImage, type UploadedImage } from "@yingce/services/image-storage";
...
import { applyGenerationConsumerEffect, generationEffectApplied } from "@yingce/services/generation-consumer-dedupe";
import { commitProducedModel } from "@yingce/lib/canvas/produced-model";
import { CanvasNodeType, type CanvasGenerationMode, type CanvasNodeData, type CanvasNodeMetadata } from "@yingce/types/canvas";
...
export async function syncGenerationTaskToCanvasStore(task: GenerationTask) {
    ...
    const { loadCanvasProjectForEditing } = await import("@yingce/services/user-data-sync");
