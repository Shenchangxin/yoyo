// @ts-nocheck
import { maxModelInputCapacity, type ModelInputSummary } from "@yingce/lib/model-selection";
import { getNodeAcceptedInputKinds, getNodeGenerationMode, getNodeInputKind, getNodeMaxInputCount } from "@yingce/lib/canvas/node-registry";
