// @ts-nocheck
import { getDataUrlByteSize } from "@yingce/lib/image-utils";
import { canvasNodeVideoPreviewUrl } from "@yingce/lib/canvas/canvas-media-preview";
import type { Asset, AssetCategory, NewAsset } from "@yingce/stores/use-asset-store";
import { CanvasNodeType, type CanvasNodeData, type CanvasNodeTypeId } from "@yingce/types/canvas";
