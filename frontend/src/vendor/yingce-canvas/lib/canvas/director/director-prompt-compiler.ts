// @ts-nocheck
import type { DirectorCamera, DirectorObject, DirectorScene, DirectorShot } from "@yingce/types/director";
import { directorColorLabel, directorPoseLabel } from "@yingce/lib/canvas/director/director-scene";
