// @ts-nocheck
import { resolveDirectorPlacement } from "@yingce/lib/canvas/director/director-placement";
import { createDirectorModel, touchDirectorScene } from "@yingce/lib/canvas/director/director-scene";
import type { DirectorObject, DirectorScene, DirectorVec3 } from "@yingce/types/director";
