...
import { createDirectorActor, createDirectorCamera, createDirectorLight, createDirectorObject, directorFocalLengthToFov, DIRECTOR_ACTOR_COLORS } from "@yingce/lib/canvas/director/director-scene";
import type { DirectorCamera, DirectorLight, DirectorObject, DirectorScene, DirectorShot } from "@yingce/types/director";
