// @ts-nocheck
import { NODE_DEFAULT_SIZE, getNodeSpec } from "@yingce/constant/canvas";
import { PromptTemplateOperation } from "@yingce/lib/prompts";
import { STORYBOARD_HEADER_HEIGHT, STORYBOARD_ROW_HEIGHT, storyboardTableHeight } from "@yingce/lib/canvas/canvas-storyboard-layout";
import { normalizeStoryboardAssetBindings } from "@yingce/lib/canvas/canvas-storyboard-assets";
import { bindingForConnectedNode, storyboardComposerContent, storyboardRowReferenceNodeIds } from "@yingce/lib/canvas/canvas-storyboard-materializer";
import type { CanvasImageAngleParams } from "@yingce/components/canvas/canvas-node-angle-dialog";
import type { NodeGenerationInput } from "@yingce/components/canvas/canvas-node-generation";
import { isFrameNode } from "@yingce/lib/canvas/canvas-frame";
import { nodeSizeFromRatio } from "@yingce/lib/canvas/canvas-node-size";
import { canvasNodeMentionToken, canvasResourceMentionToken, type CanvasResourceReference } from "@yingce/lib/canvas/canvas-resource-references";
import { getNodeDefinition } from "@yingce/lib/canvas/node-registry";
import { batchReferenceHandleY } from "@yingce/lib/canvas/canvas-batch-table";
import { reconcileImageBatchRoot } from "@yingce/lib/canvas/canvas-image-batch-retry";
import { scopedLocalStorage } from "@yingce/lib/user-scope";
import type { GenerationTask } from "@yingce/services/api/task-center";
import { synchronizeGenerationSpec } from "@yingce/lib/canvas/generation-contract";
import { CanvasNodeType, type CanvasConnection, type CanvasNodeData, type CanvasNodeMetadata, type CanvasNodeTypeId, type ConnectionHandle, type Position, type StoryboardColumn, type StoryboardRow } from "@yingce/types/canvas";
