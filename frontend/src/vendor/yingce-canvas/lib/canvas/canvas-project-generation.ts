...
import { backendProviderConfig, logicalModelIDForConfig, runBackendGenerationTask, type GenerationTaskDependencies } from "@yingce/services/api/generation-task";
import { configuredModelMatchesCapability, defaultConfig, normalizeModelOptionValue, normalizeRunningHubCapability, resolveModelRequestConfig, type AiConfig, type WorkflowFieldMapping } from "@yingce/stores/use-config-store";
import { resolveImageUrl, uploadImage } from "@yingce/services/image-storage";
import { resolveMediaUrl } from "@yingce/services/file-storage";
import { resourceIdFromStorageKey } from "@yingce/services/api/resources";
import { NODE_DEFAULT_SIZE } from "@yingce/constant/canvas";
import { normalizeVideoDuration, normalizeVideoResolution } from "@yingce/lib/video-generation-options";
import { isSeedanceVideoConfig } from "@yingce/lib/seedance-video";
import { modelCapabilityConfigFor, workflowFieldCurrentValue, workflowFieldHasStoredValue, workflowFieldKey, workflowFieldRandomKey, workflowFieldSubmissionValue, workflowOutputSizeValue, workflowVideoFieldsFromJson } from "@yingce/lib/model-capabilities";
import { modelRequestOptions, resolveCompatibleModel, resolveModelGenerationDefaults, resolveVideoOperation, type ModelGenerationDefaults, type ModelRequirements } from "@yingce/lib/model-selection";
import { imageMetadata } from "@yingce/lib/canvas/canvas-generation-task-sync";
import { producedModelCandidateForGeneration } from "@yingce/lib/canvas/produced-model";
import { ensureMediaNodeMinimumSize } from "@yingce/lib/canvas/canvas-node-size";
import { interruptFileUpload } from "@yingce/lib/canvas/canvas-file-upload";
import { isCanvasWorkflowProvider, resolveCanvasWorkflowProvider } from "@yingce/lib/canvas/canvas-workflow";
import type { CanvasNodeGenerationMode } from "@yingce/components/canvas/canvas-node-prompt-panel";
import { CanvasNodeType, type CanvasAssistantSession, type CanvasConnection, type CanvasImageGenerationType, type CanvasNodeData, type CanvasNodeMetadata, type CanvasVideoEditOperation } from "@yingce/types/canvas";
import type { ReferenceImage } from "@yingce/types/image";
import type { ReferenceAudio, ReferenceVideo } from "@yingce/types/media";
import { generationSpecMetadata, readNodeGenerationSpec, resolveGenerationSelection } from "@yingce/lib/canvas/generation-contract";
...
export { resetGenerationTaskMetadata } from "@yingce/lib/canvas/canvas-task-state";
