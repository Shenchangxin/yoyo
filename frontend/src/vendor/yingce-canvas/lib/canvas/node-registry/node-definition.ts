...
import type { CanvasResourceKind } from "@yingce/lib/canvas/canvas-resource-references";
import type { CanvasGenerationMode, CanvasNodeData, CanvasNodeMetadata, CanvasNodeTypeId } from "@yingce/types/canvas";
import type { PluginCanvasNodeContribution } from "@yingce/lib/plugins/plugin-types";
