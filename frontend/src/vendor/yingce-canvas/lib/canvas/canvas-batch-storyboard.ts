// @ts-nocheck
import { createStoryboardRow } from "@yingce/lib/canvas/canvas-project-domain";
import type { CanvasBatchRow, CanvasBatchTableData, CanvasNodeData, StoryboardRow } from "@yingce/types/canvas";
