...
import type { CanvasDrawingEngine } from "@yingce/lib/canvas/canvas-drawing-engine";
...
export async function createCanvasDrawingFromImage(
    ...
    const document = engine === "excalidraw"
        ? (await import("@yingce/lib/canvas/canvas-drawing-excalidraw-document")).createExcalidrawDrawingFromImage(source)
        : await (await import("@yingce/lib/canvas/canvas-drawing-tldraw-document")).createTldrawDrawingFromImage(source);
