// @ts-nocheck
import { CanvasNodeType, type CanvasConnection, type CanvasNodeData, type Position } from "@yingce/types/canvas";
import { buildCanvasSpatialIndex, canvasNodeBounds, type CanvasSpatialIndex } from "@yingce/lib/canvas/canvas-spatial-index";
