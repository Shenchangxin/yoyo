...
export type PluginAgentAction = {
    ...
    buildOperations: (input: Record<string, unknown>, snapshot: import("@yingce/lib/canvas/canvas-operation-contract").CanvasSnapshot) => import("@yingce/lib/canvas/canvas-operation-contract").CanvasOperation[];
};

export type RegisteredPlugin = {
    agentActions?: PluginAgentAction[];
    /** Pure, bounded projection: never return embedded media or provider credentials. */
    readAgentNode?: (node: import("@yingce/types/canvas").CanvasNodeData, snapshot: import("@yingce/lib/canvas/canvas-operation-contract").CanvasSnapshot) => Record<string, unknown>;
