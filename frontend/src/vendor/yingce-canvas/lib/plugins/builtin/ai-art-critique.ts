// @ts-nocheck
import { registerPlugin } from "@yingce/lib/plugins/plugin-registry";
import type { PluginManifest, RegisteredPlugin } from "@yingce/lib/plugins/plugin-types";

import { ART_CRITIQUE_NODE_TYPE, ART_CRITIQUE_PLUGIN_ID, artCritiqueSourceFingerprint, createDefaultArtCritiqueState } from "@yingce/lib/art-critique/contracts";
