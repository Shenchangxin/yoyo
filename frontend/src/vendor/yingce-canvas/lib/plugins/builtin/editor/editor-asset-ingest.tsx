...
import { useEditorHostContext, useEditorStoreContext } from "@yingce/components/editor/editor-context";
import { defaultAssetCategoryForKind } from "@yingce/lib/asset-category";
import { probeMediaDurationMs } from "@yingce/lib/media-metadata";
import { makeClipFromAsset } from "@yingce/lib/timeline/asset-ingest";
import { DEFAULT_AUDIO_TRACK_ID, DEFAULT_SUBTITLE_TRACK_ID, DEFAULT_VIDEO_TRACK_ID } from "@yingce/lib/timeline/timeline-tracks";
import { linkProjectAsset } from "@yingce/services/api/projects";
import { uploadResourceFile, type ResourceUploadMeta } from "@yingce/services/api/resources";
import { resolveMediaUrl } from "@yingce/services/file-storage";
import type { ProjectAsset } from "@yingce/services/api/projects";
