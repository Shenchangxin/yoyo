...
import type { PluginManifestV2, RegisteredPlugin } from "@yingce/lib/plugins/plugin-types";
import { registerEditorSlot } from "@yingce/lib/plugins/editor-slot-registry";
