...
import { imageSizeConfigWithPresets, imageSizePresets } from "@yingce/lib/image-size-presets";
...
import { defaultImageCapabilityConfig, defaultModelCapabilityConfig, normalizeModelCapabilityConfig, type ImageCapabilityConfig, type ModelCapabilityConfig, type TextCapabilityConfig, type VideoCapabilityConfig } from "@yingce/lib/model-capabilities";
import type { ModelProtocol } from "@yingce/lib/model-protocols";
import { VIDEO_RESOLUTION_CAPABILITY_OPTIONS } from "@yingce/lib/video-generation-options";
