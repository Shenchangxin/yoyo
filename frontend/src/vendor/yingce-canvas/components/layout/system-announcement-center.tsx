...
import { getAnnouncementFeed, markAnnouncementsRead } from "@yingce/services/api/announcements";

const AnnouncementTimelineModal = lazy(() => import("@yingce/components/ui/aceternity/announcement-timeline-modal").then((module) => ({ default: module.AnnouncementTimelineModal })));
