...
import { bannerNoticeSurfaceCSS } from "@yingce/lib/announcements/banner-notice";
import { bannerTitleRunStyle, type BannerTitleRun } from "@yingce/lib/announcements/banner-title";
