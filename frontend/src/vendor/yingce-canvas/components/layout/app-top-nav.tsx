...
import { BannerAnnouncementsSlider } from "@yingce/components/layout/banner-announcements-slider";
import { ModelSetupGuide } from "@yingce/components/layout/model-setup-guide";
import { WorkspaceSidebarNav } from "@yingce/components/layout/workspace-sidebar-nav";
import { readWorkspaceSidebarCollapsed, writeWorkspaceSidebarCollapsed } from "@yingce/components/layout/workspace-sidebar-state";
import { WorkspaceTopBar } from "@yingce/components/layout/workspace-top-bar";
import { WorkspaceTopBarExtensionProvider } from "@yingce/components/layout/workspace-top-bar-extension";
import { WorkspaceWalletHost } from "@yingce/components/layout/workspace-wallet-modal";
import { cn } from "@yingce/lib/utils";
import { isSpatialWorkbenchPath } from "@yingce/lib/workspace-routes";

const WorkspaceCommandPalette = lazy(() => import("@yingce/components/layout/workspace-command-palette").then((module) => ({ default: module.WorkspaceCommandPalette })));
