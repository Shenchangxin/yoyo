...
import { CheckboxGroup } from "@yingce/components/ui/base/checkbox";
...
import { buildGenerationConfig } from "@yingce/lib/canvas/canvas-project-generation";
import type { CanvasResourceReference } from "@yingce/lib/canvas/canvas-resource-references";
import { pipelineStatusLabel, type CanvasStoryboardPipelineProgress, type StoryboardPipelineStage } from "@yingce/lib/canvas/canvas-storyboard-progress";
import { generationErrorMessage, isContentModerationError } from "@yingce/lib/generation-error";
import { generationTaskShowsProgress, generationTaskStageLabel } from "@yingce/lib/generation-task-display";
...
import { STORYBOARD_COMPOSER_MIN_HEIGHT, STORYBOARD_HEADER_HEIGHT, STORYBOARD_ROW_HEIGHT, storyboardTableHeight } from "@yingce/lib/canvas/canvas-storyboard-layout";
import type {
...
import type { TaskStatus } from "@yingce/services/api/task-center";
