...
import { AlertCircle, BookOpenCheck, CheckCircle2, ChevronRight, Clapperboard, Copy, Download, GripVertical, Image as ImageIcon, Lock, Maximize2, Music2, Pencil, RefreshCw, ScanSearch, Settings2, Star, Trash2, Type, Video } from "lucide-react";
...
import { canvasConnectionTilt } from "@yingce/lib/canvas/canvas-connection-tilt";
import { storyboardMinNodeHeight } from "@yingce/lib/canvas/canvas-storyboard-layout";
...
import { CanvasNodeType, type CanvasNodeData, type CanvasNodeTypeId, type Position } from "@yingce/types/canvas";
...
import { getNodeDefinition, getNodeMinSize, shouldKeepAspectRatio } from "@yingce/lib/canvas/node-registry";
