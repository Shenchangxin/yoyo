...
import { FloatingDock, type FloatingDockEntry } from "@yingce/components/ui/aceternity/floating-dock";
...
import type { ImageAsset } from "@yingce/stores/use-asset-store";
