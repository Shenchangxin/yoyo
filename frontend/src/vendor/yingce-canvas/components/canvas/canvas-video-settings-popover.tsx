...
import { VideoSettingsPanel, videoResolutionLabel, videoSecondsLabel, videoSizeLabel } from "@yingce/components/video-settings-panel";
import { canvasThemes } from "@yingce/lib/canvas-theme";
import { modelCapabilityConfigFor, resolveVideoRatioValue, resolveVideoResolutionValue } from "@yingce/lib/model-capabilities";
...
function VideoSettingsPortal({
    ...
    return (
        <GenerationSettingsPortal buttonRect={buttonRect} panelRef={panelRef} placement={placement} width={Math.min(360, window.innerWidth - 24)} estimatedHeight={370}>
