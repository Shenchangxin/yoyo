...
import { ASSET_CATEGORY_LABELS, type AssetCategory } from "@yingce/lib/asset-category";
import { resourceStorageLabel } from "@yingce/lib/canvas/resource-storage-status";
import { loadAssetLibraryPage } from "@yingce/services/user-data-sync";
