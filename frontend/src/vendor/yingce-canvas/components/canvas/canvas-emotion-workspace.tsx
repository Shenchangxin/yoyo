...
import { CanvasNodeEmotionPanel, type CanvasEmotionCharacter, type CanvasImageEmotionPayload } from "@yingce/components/canvas/canvas-node-emotion-panel";
import { CanvasNodePanelOverlay } from "@yingce/components/canvas/canvas-workspace-overlays";
...
import { buildEmotionImageArtifacts, buildEmotionPrompt, neutralEmotionPreset, type CanvasEmotionPreset, type CanvasFaceBox } from "@yingce/lib/canvas/canvas-emotion";
import { detectCanvasFaces } from "@yingce/lib/canvas/canvas-face-detection";
...
import type { CanvasNodeData, Position, ViewportTransform } from "@yingce/types/canvas";
