...
import { resolveCanvasAppearance, resolveCanvasGridColor, type CanvasAppearance } from "@yingce/lib/canvas/canvas-appearance";
import { resolveCanvasPointerIntent } from "@yingce/lib/canvas/canvas-selection";
import type { CanvasBackgroundMode } from "@yingce/lib/canvas-theme";
import { applyCanvasLiveViewport, subscribeCanvasViewportPreview } from "@yingce/lib/canvas/canvas-live-viewport";
import { useActiveTheme } from "@yingce/stores/canvas/use-canvas-theme-store";
import type { ViewportTransform } from "@yingce/types/canvas";
