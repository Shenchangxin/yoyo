...
import { AssetLibraryPickerModal, type AssetLibraryPickerItem, type AssetPickerMediaKind } from "@yingce/components/assets/asset-library-picker-modal";
import { useExternalAssetSources } from "@yingce/hooks/use-external-asset-sources";
import { externalAssetToInsertPayload, type InsertAssetPayload } from "@yingce/components/canvas/asset-picker-modal";
import { compileCharacterReferencePrompt } from "@yingce/lib/canvas/canvas-character-reference";
import { ASSET_CATEGORY_LABELS, normalizeAssetCategory } from "@yingce/lib/asset-category";
import { resourceFileUrl, resourceIdFromStorageKey } from "@yingce/services/api/resources";
import type { ProjectAsset, ProjectDetail } from "@yingce/services/api/projects";
import { getRemoteAsset } from "@yingce/services/api/user-data";
