...
import type { PluginInstallation, PluginManifest, PluginManifestV2 } from "@yingce/lib/plugins/plugin-types";
import type { PluginState } from "@yingce/services/api/plugins";
