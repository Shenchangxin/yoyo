...
import {
    ...
    undoEditorHistory,
    type EditorHistory,
} from "@yingce/lib/timeline/editor-history";
import { getEditorCommandRegistry, type EditCommand, type EditorCommandRegistry } from "@yingce/lib/timeline/editor-commands";
 ...
 * 创建一个项目级时间线状态容器。
 *
 * 状态容器不负责远端持久化：saveTimeline 是调用方注入的本地存储适配器，
