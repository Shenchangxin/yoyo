...
import type { AssetCategory } from "@yingce/lib/asset-category";
import { parseAssetRecord } from "@yingce/lib/asset-record";
import { parseAssetStorageDocumentRecovering, rebaseAssetSnapshot, serializeAssetStorageDocument, type AssetStorageDocument } from "@yingce/lib/asset-storage-revision";
import { parseCanvasStorageDocument } from "@yingce/lib/canvas/canvas-storage-revision";
import { localForageStorageForScope } from "@yingce/lib/localforage-storage";
...
import { cleanupUnusedImages, collectImageStorageKeys, resolveImageUrl, uploadImage } from "@yingce/services/image-storage";
import { cleanupUnusedMedia, collectMediaStorageKeys, resolveMediaUrl } from "@yingce/services/file-storage";
import { flushGenerationAssetStorageLocks, insertOrReturnGenerationAsset, withGenerationArtifactCommitLock, withGenerationAssetStorageLock } from "@yingce/services/generation-asset-repository";
import { CANVAS_STORE_KEY, commitPendingCanvasStorePersistenceLocked, pendingCanvasStorePersistence, withCanvasStorePersistenceLock } from "@yingce/stores/canvas/use-canvas-store";
import { readAllCanvasSyncDrafts } from "@yingce/services/canvas-sync-drafts";

export type AssetKind = "text" | "image" | "video" | "audio" | "model" | "entity";
export type { AssetCategory } from "@yingce/lib/asset-category";
