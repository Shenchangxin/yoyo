...
import { sameCanvasContent } from "@yingce/lib/canvas/canvas-content";
import { canvasAppearanceForTheme, DEFAULT_CANVAS_BACKGROUND_MODE, normalizeCanvasAppearance, readCanvasAppearanceDefault, type CanvasAppearance } from "@yingce/lib/canvas/canvas-appearance";
import { parseCanvasStorageDocument, rebaseCanvasProjects, serializeCanvasStorageDocument, type CanvasStorageDocument } from "@yingce/lib/canvas/canvas-storage-revision";
...
import { DEFAULT_CANVAS_COLOR_THEME, type CanvasBackgroundMode } from "@yingce/lib/canvas-theme";
import type { CanvasStarterMode } from "@yingce/lib/canvas/canvas-starter";
...
import type { TimelineProject } from "@yingce/types/timeline";
