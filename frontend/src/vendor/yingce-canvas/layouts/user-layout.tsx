...
import { AppWorkspaceShell } from "@yingce/components/layout/app-top-nav";
import { cn } from "@yingce/lib/utils";
import { isSpatialWorkbenchPath } from "@yingce/lib/workspace-routes";
import { getWorkspaceAntThemeConfig } from "@yingce/lib/app-theme";
import { useWorkspaceButtonFeedback } from "@yingce/hooks/use-workspace-button-feedback";
import "@yingce/styles/workspace-product.css";
import "@yingce/styles/workspace-menus.css";
...
export default function UserLayout({ children }: { children: ReactNode }) {
    ...
    return (
        ...
        >
            <div className={cn("app-user-workspace h-full min-h-0 overflow-hidden text-foreground", spatialWorkbench && "app-spatial-workspace", productWorkspace && "app-product-workspace")}>
