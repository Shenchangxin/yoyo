...
import { applyMaterializedGenerationTaskResultToNodes } from "@yingce/lib/canvas/canvas-generation-task-sync";
...
import { parseCanvasStorageDocument, rebaseCanvasProjects, serializeCanvasStorageDocument } from "@yingce/lib/canvas/canvas-storage-revision";
...
import { generationEffectApplied } from "@yingce/services/generation-consumer-dedupe";
import {
    CANVAS_STORE_KEY,
    ...
    type CanvasProject,
} from "@yingce/stores/canvas/use-canvas-store";
import type { CanvasAssistantSession, CanvasConnection, CanvasNodeData } from "@yingce/types/canvas";
