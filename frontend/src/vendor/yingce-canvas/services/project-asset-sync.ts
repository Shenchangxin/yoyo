// @ts-nocheck
import { canvasNodeToAsset, declaredCanvasNodeAssetCategory, findCanvasNodeAsset, type CanvasAssetSource } from "@yingce/lib/canvas/canvas-node-asset";
import { canvasVideoAssetPreviewUrl } from "@yingce/lib/canvas/canvas-media-preview";
import { readImageMeta } from "@yingce/lib/image-utils";
import { parseBackendGenerationResult, type BackendGenerationResult } from "@yingce/services/api/generation-task";
import { ApiError } from "@yingce/services/api/request";
import { linkProjectAsset, moveProjectAsset, updateProjectAssetCategory } from "@yingce/services/api/projects";
import type { GenerationTask, GenerationTaskOutput } from "@yingce/services/api/task-center";
import { getMediaBlob, resolveMediaUrl, setMediaBlob } from "@yingce/services/file-storage";
import { createGenerationTaskMaterializer, createIdempotentMaterializeOutput, type MaterializeGenerationTaskOutput } from "@yingce/services/generation-task-materializer";
import { withGenerationArtifactCommitLock } from "@yingce/services/generation-asset-repository";
import { uploadGeneratedAssetToConfiguredSources } from "@yingce/services/external-asset-sources";
import { getImageBlob, resolveImageUrl, setImageBlob } from "@yingce/services/image-storage";
import { generationArtifactStorageKey, loadOrStoreGenerationArtifact } from "@yingce/services/generation-artifact-sink";
import { createProviderNeutralGenerationTaskEffectStore } from "@yingce/services/provider-neutral-generation-effects";
import { getCachedResourceBlob } from "@yingce/services/resource-blob-cache";
import { saveRemoteUserDataNow } from "@yingce/services/user-data-sync";
import { getActiveUserScope } from "@yingce/lib/user-scope";
import { normalizeAssetCategory } from "@yingce/lib/asset-category";
import { runGenerationConsumer } from "@yingce/services/generation-consumer-lifecycle";
import { useAssetStore, type AssetCategory, type AssetStatus, type NewAsset } from "@yingce/stores/use-asset-store";
