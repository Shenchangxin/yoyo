// @ts-nocheck
import type { CanvasAssistantMessage, CanvasAssistantSession } from "@yingce/types/canvas";
...
import { createCanvasProjectWithRemoteSync, hasRemoteUserDataSyncSession, loadCanvasProjectForEditing, saveRemoteUserDataNow } from "@yingce/services/user-data-sync";
