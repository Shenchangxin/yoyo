...
import { applyCanvasOperations, type CanvasOperation, type CanvasSnapshot } from "@yingce/lib/canvas/canvas-operation-contract";
import { buildCanvasContext } from "@yingce/lib/canvas/canvas-context-discovery";
import { applyCreativeAnswers, creativeScenarioPrompt, normalizeCreativeQuestions, CREATIVE_SCENARIOS, type CreativeAnswers, type CreativeQuote } from "@yingce/lib/creation/creative-agent-contract";
import { assertCreativeBriefSpecifications, creativeNodeId, creativeProposalOps, initialCreativeState, mergeCreativeBrief, normalizeCreativeProposal, readCreativeState, type CreativeAgentState, type CreativeMediaState } from "@yingce/lib/creation/creative-agent-state";
import { CREATIVE_AGENT_SYSTEM_PROMPT, CREATIVE_AGENT_TOOLS, parseCreativeToolArguments } from "@yingce/lib/creation/creative-agent-tools";
import { modelCapabilityConfigFor } from "@yingce/lib/model-capabilities";
import { submittedProducedModel } from "@yingce/lib/canvas/produced-model";
import { getActiveUserScope } from "@yingce/lib/user-scope";
import { logicalModelIDForConfig, modelDisplayName, resolveModelRequestConfig, selectableModelsByCapability, type AiConfig } from "@yingce/stores/use-config-store";
...
import { creativeVideoSpecificationError } from "@yingce/lib/creation/creative-agent-state";
import { updateCreativePlan } from "@yingce/lib/creation/creative-plan";
