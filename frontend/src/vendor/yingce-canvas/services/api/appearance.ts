...
import type { SkinDefinition } from "@yingce/lib/skin-themes";
import type { CanvasAppearance } from "@yingce/lib/canvas/agent-appearance";
import { apiBaseURL } from "@yingce/services/api/request";
