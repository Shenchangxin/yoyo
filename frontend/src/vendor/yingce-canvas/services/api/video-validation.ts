// @ts-nocheck
import { modelCapabilityConfigFor, videoDurationAllowed } from "@yingce/lib/model-capabilities";
import { resolveModelRequestConfig } from "@yingce/stores/use-config-store";
