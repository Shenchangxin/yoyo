// @ts-nocheck
import { resolveModelRequestConfig, type AiConfig } from "@yingce/stores/use-config-store";
import { dataUrlToFile } from "@yingce/lib/image-utils";
import { buildImageReferencePromptText } from "@yingce/lib/image-reference-prompt";
import { imageToDataUrl } from "@yingce/services/image-storage";
import type { ReferenceImage } from "@yingce/types/image";
import { withOpenAIPromptCacheKey } from "@yingce/lib/openai-prompt-cache";
import { modelCapabilityConfigFor, normalizeImageValue } from "@yingce/lib/model-capabilities";
import { buildGeminiImageGenerationConfig, parseGeminiImageDataUrl, type GeminiImageGenerationConfig } from "@yingce/lib/gemini-image";
import { isVolcengineArkImageProtocol } from "@yingce/lib/model-protocols";
import { aiApiUrl, aiHeaders, imageChannelTransport, postChannelJSON, postGeminiJSON, postVolcengineArkImage } from "@yingce/services/api/image-transport";

const IMAGE_OUTPUT_FORMAT = "png";
import type { AiTextMessage, GeminiPart, ImageApiResponse, RequestOptions, ResponseApiPayload, ResponseFunctionTool, ResponseInputMessage, ToolChoice, ToolResponseResult } from "@yingce/services/api/image-contracts";
import { normalizeGrokImageResolution, normalizeQuality, normalizeVolcengineArkImageSize, resolveImageRequestSize, validateImageCapability } from "@yingce/services/api/image-validation";
import { parseGeminiImagePayload, parseImagePayload, readAxiosError } from "@yingce/services/api/image-response";
import { toChatCompletionMessages, toChatCompletionToolChoice, toClaudeBody, toGeminiBody, toGeminiToolOptions, toResponseInput, toResponseTool, withSystemMessage } from "@yingce/services/api/image-protocols";
import { requestGeminiStreamingResponse, requestStreamingChatCompletion, requestStreamingClaude, requestStreamingResponse } from "@yingce/services/api/image-streaming";
export { buildBackendToolRequests } from "@yingce/services/api/image-protocols";
export type { AiTextContentPart, AiTextMessage, ResponseFunctionTool, ResponseInputMessage, ResponseToolCall, ToolChoice, ToolResponseResult } from "@yingce/services/api/image-contracts";
...
export { fetchChannelModels, fetchImageModels } from "@yingce/services/api/image-models";
export type { ChannelModelFetchResult } from "@yingce/services/api/image-models";
