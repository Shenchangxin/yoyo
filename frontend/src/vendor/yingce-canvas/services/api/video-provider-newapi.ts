// @ts-nocheck
import { modelCapabilityConfigFor, videoResolutionRequest } from "@yingce/lib/model-capabilities";
import { boolConfig } from "@yingce/lib/seedance-video";
import { getResourceInputURL } from "@yingce/services/api/resources";
import { modelOptionName } from "@yingce/stores/use-config-store";
