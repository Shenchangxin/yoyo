...
import type { RemoteResource } from "@yingce/services/api/resources";
import type { BannerNoticeType } from "@yingce/lib/announcements/banner-notice";
import type { BannerTitleRun } from "@yingce/lib/announcements/banner-title";
