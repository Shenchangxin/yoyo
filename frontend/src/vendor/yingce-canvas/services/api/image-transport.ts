// @ts-nocheck
import { buildApiUrl, isSystemProxyBaseUrl, resolveBackendApiUrl, type AiConfig } from "@yingce/stores/use-config-store";
import { createClientId } from "@yingce/lib/client-id";
import { createChannelTransport } from "@yingce/services/api/channel-transport";
import type { GeminiPayload, ImageApiResponse, RequestOptions } from "@yingce/services/api/image-contracts";
