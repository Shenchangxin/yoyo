...
import { MediaPlaceholder } from "@yingce/components/ui/product/media-placeholder";
...
import { settingsPath } from "@yingce/lib/settings-navigation";
import { PromptTemplateOperation, parseGeneratedStory, promptTemplateTaskPlaceholder, shortDramaOutlineVariables } from "@yingce/lib/prompts";
import { runBackendGenerationTask } from "@yingce/services/api/generation-task";
import { createProject, deleteProject, importProjectUnits, listProjects, type ProjectSummary } from "@yingce/services/api/projects";
import { modelDisplayName, useEffectiveConfig } from "@yingce/stores/use-config-store";
