...
import { assetCategoryLabel as sharedAssetCategoryLabel } from "@yingce/lib/asset-category";
import type { ProjectDetail, ProjectShot, ShotArtifact, ShotRevision, WorkflowStep } from "@yingce/services/api/projects";
