...
import { assetCategoryLabel, normalizeAssetCategory } from "@yingce/lib/asset-category";
import { resourceFileUrl, resourceIdFromStorageKey, resourceStorageKey } from "@yingce/services/api/resources";
import type { CharacterRepresentation, ProjectAsset, ProjectDetail, ShotAssetReference } from "@yingce/services/api/projects";
import type { AssetCategory } from "@yingce/stores/use-asset-store";
import type { ReferenceImage } from "@yingce/types/image";
import type { ReferenceAudio } from "@yingce/types/media";
