// @ts-nocheck
import { ImageSizePicker } from "@yingce/components/image-size-picker";
import { imageResolutionUsesQuality } from "@yingce/lib/image-size-presets";
import { useEffect, useMemo, useRef, useState, type ReactNode } from "react";
import { useMutation, useQuery } from "@tanstack/react-query";
import { App, Button, Form, Image, Input, InputNumber, Select } from "antd";
import { SegmentedControl } from "@yingce/components/ui/base/segmented-control";
...
import { modelCapabilityConfigFor, normalizeImageValue, normalizeVideoValue, videoDurationOptions } from "@yingce/lib/model-capabilities";
import { modelQuoteDescription, modelQuoteRequest } from "@yingce/lib/model-pricing";
import { customShotTitle, formatShotOrdinal, normalizeDefaultShotTitle } from "@yingce/lib/shot-label";
import { modelCompatibilityError, resolveCompatibleModel, resolveModelVideoBooleanOptions, type ModelRequirements } from "@yingce/lib/model-selection";
import { formatVideoResolutionLabel } from "@yingce/lib/video-generation-options";
import { submitBackendGenerationTask } from "@yingce/services/api/generation-task";
import { quoteModel, type LogicalModelQuote } from "@yingce/services/api/logical-models";
...
import {
    ...
    type WorkflowStep,
} from "@yingce/services/api/projects";
import { resourceFileUrl, resourceIdFromStorageKey, resourceStorageKey } from "@yingce/services/api/resources";
import { skillRuntime } from "@yingce/services/skill-runtime";
import { configuredModelMatchesCapability, modelDisplayName, modelOptionName, resolveModelChannel, selectableModelsByCapability, useConfigStore, useEffectiveConfig } from "@yingce/stores/use-config-store";
import { useUserStore } from "@yingce/stores/use-user-store";
import { SkillRuntimePicker, useSkillRuntimeCatalog } from "@yingce/components/skills/skill-runtime-picker";
