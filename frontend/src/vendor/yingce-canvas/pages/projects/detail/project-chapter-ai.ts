// @ts-nocheck
import { runBackendCanvasGenerationTask } from "@yingce/lib/canvas/canvas-project-generation";
import { PromptTemplateOperation, promptTemplateTaskPlaceholder } from "@yingce/lib/prompts";
import { storyboardRowsFromTask, storyboardRowsOutputContract } from "@yingce/lib/canvas/canvas-project-domain";
import { parseChapterAssetBreakdown, type ChapterAssetBreakdown } from "@yingce/lib/canvas/chapter-asset-breakdown";
import { parseCharacterBreakdown } from "@yingce/lib/canvas/canvas-character-reference";
import { backendProviderConfig, parseBackendGenerationResult } from "@yingce/services/api/generation-task";
import { createGenerationTask, waitForGenerationTask, type GenerationTask } from "@yingce/services/api/task-center";
import type { Skill } from "@yingce/services/api/skills";
import { skillRuntime } from "@yingce/services/skill-runtime";
import { logicalModelIDForConfig, type AiConfig } from "@yingce/stores/use-config-store";
