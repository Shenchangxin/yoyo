...
import type { ProjectDetail, ProjectUnit } from "@yingce/services/api/projects";
import { ASSET_CATEGORY_LABELS, assetCategoryLabel as sharedAssetCategoryLabel } from "@yingce/lib/asset-category";
