...
import { getProjectCore, getProjectOverview, getProjectUnitWorkspace, linkCanvasUnit, listProjectUnits } from "@yingce/services/api/projects";
import { WorkspacePage } from "@yingce/components/layout/workspace-page";
import { WorkspaceErrorState, WorkspaceLoadingState } from "@yingce/components/layout/workspace-state";
import type { ProjectDetail } from "@yingce/services/api/projects";
    ...
    const createCanvas = async () => {
        ...
        try {
            const [{ createCanvasProjectWithRemoteSync }, storyboard] = await Promise.all([
                import("@yingce/services/user-data-sync"),
                unit && shots.length ? import("@yingce/lib/canvas/project-chapter-storyboard") : Promise.resolve(null),
            ]);
