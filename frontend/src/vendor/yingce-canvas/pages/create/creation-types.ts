// @ts-nocheck
import type { GenerationRetryContext } from "@yingce/lib/canvas/canvas-project-generation";
import { formatVideoResolutionLabel as videoResolutionLabel, VIDEO_RESOLUTION_OPTIONS } from "@yingce/lib/video-generation-options";
