// @ts-nocheck
import { modelCapabilityConfigFor, normalizeVideoValue } from "@yingce/lib/model-capabilities";
import { resolveModelVideoBooleanOptions } from "@yingce/lib/model-selection";
