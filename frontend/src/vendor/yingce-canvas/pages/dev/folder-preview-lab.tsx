...
import { CANVAS_FOLDER_THEME_OPTIONS } from "@yingce/lib/canvas/canvas-folder-theme";
import { useThemeStore } from "@yingce/stores/use-theme-store";
import type { CanvasFolderStyle, CanvasFolderTheme, CanvasNodeData } from "@yingce/types/canvas";
