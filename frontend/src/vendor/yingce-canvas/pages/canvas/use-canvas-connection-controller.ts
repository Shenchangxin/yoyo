...
import { latchCanvasConnectionApproach, type CanvasConnectionApproach } from "@yingce/lib/canvas/canvas-connection-tilt";

import type { PendingConnectionCreate } from "@yingce/components/canvas/canvas-workspace-overlays";
import { getNodeSpec } from "@yingce/constant/canvas";
import { batchSourceRestriction, buildBatchConnectionCreateRequest, hasBatchConnectionCandidate, planBatchConnections, type CanvasBatchConnectionPreview } from "@yingce/lib/canvas/canvas-batch-connection";
import { batchReferenceHandleAtY } from "@yingce/lib/canvas/canvas-batch-table";
import { connectedNodeCenterFromEdgeDrop } from "@yingce/lib/canvas/canvas-connected-node-placement";
import { canvasConnectionError } from "@yingce/lib/canvas/canvas-connection-policy";
import { attachNodeToStoryboardRow, createCanvasNode, getConnectionTargetAnchor, isHiddenBatchChild, normalizeConnection, storyboardHandleAtY, storyboardPromptTemplateMetadata, storyboardRowFromHandle } from "@yingce/lib/canvas/canvas-project-domain";
import { createCanvasDrawingFromImage } from "@yingce/lib/canvas/canvas-drawing-storage";
import { isDrawingEngineAvailable, type CanvasDrawingEngine } from "@yingce/lib/canvas/canvas-drawing-engine";
import { isFrameNode, isNodeHiddenByCollapsedFrame } from "@yingce/lib/canvas/canvas-frame";
import { normalizeRunningHubCapability, type AiConfig } from "@yingce/stores/use-config-store";
import { useUserStore } from "@yingce/stores/use-user-store";
import { CanvasNodeType, type CanvasConnection, type CanvasNodeData, type CanvasNodeMetadata, type ConnectionHandle, type ContextMenuState, type Position, type ViewportTransform } from "@yingce/types/canvas";
import { workflowProviderPluginEnabled } from "@yingce/lib/plugins/builtin/workflows";
