...
import { CANVAS_IMAGE_ASSET_DND_TYPE } from "@yingce/components/canvas/canvas-asset-tray";
import type { InsertAssetPayload } from "@yingce/components/canvas/asset-picker-modal";
import { CANVAS_PROJECT_CHAPTER_DND_TYPE, type CanvasProjectChapterPayload } from "@yingce/components/canvas/canvas-project-sidebar";
import { NODE_DEFAULT_SIZE } from "@yingce/constant/canvas";
import { getDataUrlByteSize, readImageMeta } from "@yingce/lib/image-utils";
import { audioMetadata, imageMetadata, videoMetadata } from "@yingce/lib/canvas/canvas-generation-task-sync";
import { createCanvasNode } from "@yingce/lib/canvas/canvas-project-domain";
import { isAudioFile } from "@yingce/lib/canvas/canvas-project-generation";
import { fitNodeSize, VIDEO_NODE_MAX_SIZE } from "@yingce/lib/canvas/canvas-node-size";
import { CANVAS_UPLOAD_ACCEPT, createFileUploadPlaceholder, uploadNodeType, uploadPercent } from "@yingce/lib/canvas/canvas-file-upload";
import { resourceIdFromStorageKey, resourceStorageKey, uploadResourceFile } from "@yingce/services/api/resources";
...
import { getProjectUnit } from "@yingce/services/api/projects";
import { ensureCanvasNodeAsset } from "@yingce/services/project-asset-sync";
import { useAssetStore, type ImageAsset } from "@yingce/stores/use-asset-store";
import { CanvasNodeType, type CanvasNodeData, type ContextMenuState, type Position } from "@yingce/types/canvas";
import type { TimelineDirectMedia } from "@yingce/types/timeline";
