...
import { CanvasNodeType, type CanvasConnection, type CanvasNodeData, type CanvasBatchTableData, type CanvasBatchRow, type StoryboardRow } from "@yingce/types/canvas";
import { runBackendGenerationTask } from "@yingce/services/api/generation-task";
import { buildGenerationConfig, resolveCanvasGenerationModel } from "@yingce/lib/canvas/canvas-project-generation";
import { modelCompatibilityError, modelRequestOptions, type ModelRequirements } from "@yingce/lib/model-selection";
import type { AiConfig } from "@yingce/stores/use-config-store";
import type { ReferenceVideo } from "@yingce/types/media";
import { createStoryboardRow, cinematicStoryboardColumns, storyboardRowsOutputContract } from "@yingce/lib/canvas/canvas-project-domain";
import type { StoryboardColumn } from "@yingce/types/canvas";
