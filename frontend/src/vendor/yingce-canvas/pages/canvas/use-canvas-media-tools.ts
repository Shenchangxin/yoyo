...
import type { CanvasImageCropRect } from "@yingce/components/canvas/canvas-node-crop-dialog";
import type { CanvasImageMaskEditPayload } from "@yingce/components/canvas/canvas-node-mask-edit-dialog";
import type { CanvasImageEditPayload } from "@yingce/components/canvas/canvas-node-image-edit-dialog";
import type { CanvasImageLayerDecompositionPayload } from "@yingce/components/canvas/canvas-node-layer-decomposition-dialog";
import { buildCanvasTextEditPrompt, type CanvasImageTextEditPayload, type CanvasImageTextLine } from "@yingce/components/canvas/canvas-node-text-edit-dialog";
import type { CanvasImageAnnotationPayload } from "@yingce/components/canvas/canvas-node-annotation-dialog";
import type { CanvasImageSplitParams } from "@yingce/components/canvas/canvas-node-split-dialog";
import type { CanvasImageUpscaleParams } from "@yingce/components/canvas/canvas-node-upscale-dialog";
import type { CanvasImageAngleParams } from "@yingce/components/canvas/canvas-node-angle-dialog";
import type { CanvasVideoSegmentParams } from "@yingce/components/canvas/canvas-video-segment-dialog";
import { buildLightingLabel, type CanvasImageLightingOptions } from "@yingce/components/canvas/canvas-node-lighting-dialog";
import type { CanvasImageEmotionPayload } from "@yingce/components/canvas/canvas-node-emotion-panel";
import type { PanoramaGenerateConfig } from "@yingce/components/canvas/canvas-panorama-config-modal";
import type { CanvasVideoFrameParams } from "@yingce/components/canvas/canvas-video-frame-dialog";
import { NODE_DEFAULT_SIZE } from "@yingce/constant/canvas";
import { cropDataUrl, splitDataUrl, upscaleDataUrl } from "@yingce/lib/canvas/canvas-image-data";
import { isValidGridSplit, layoutGridSplitCells } from "@yingce/lib/canvas/canvas-grid-split";
import { audioMetadata, imageMetadata, videoMetadata } from "@yingce/lib/canvas/canvas-generation-task-sync";
import { commitProducedModel } from "@yingce/lib/canvas/produced-model";
import { findAvailableGenerationGroupPosition, imageGenerationChildPosition, imageGenerationGroupSize } from "@yingce/lib/canvas/canvas-generation-layout";
import { canvasGenerationPromptMetadata } from "@yingce/lib/canvas/canvas-generation-submission";
import { cancelIncompleteImageBatch } from "@yingce/lib/canvas/canvas-image-batch-retry";
import { buildAngleLabel, buildAnglePrompt, createCanvasNode } from "@yingce/lib/canvas/canvas-project-domain";
import { validateVideoSegmentBatch } from "@yingce/lib/canvas/canvas-video-regeneration";
import { resolveCanvasStyleExecution } from "@yingce/lib/canvas/canvas-style-execution";
import {
...
} from "@yingce/lib/canvas/canvas-project-generation";
import { fitNodeSize, VIDEO_NODE_MAX_SIZE } from "@yingce/lib/canvas/canvas-node-size";
import { compositeEmotionImage, emotionGenerationSize, emotionProviderMask, normalizeEmotionPromptForProvider, resolveEmotionEditPlan } from "@yingce/lib/canvas/canvas-emotion";
import { DEFAULT_PORTRAIT_TEXTURE_SETTINGS } from "@yingce/lib/canvas/canvas-portrait-texture";
import { IMAGE_PROMPT_REVERSE } from "@yingce/lib/prompts";
import { createPortraitTextureNode, createNineGridNode } from "@yingce/lib/canvas/canvas-image-source";
import { captureVideoFrames } from "@yingce/lib/canvas/canvas-video-frame";
import { buildVideoFrameNodes } from "@yingce/lib/canvas/canvas-video-frame-nodes";
import { mergeVideos, type MergeVideoProgress } from "@yingce/lib/canvas/canvas-video-merge";
import { extractVideoAudio, trimVideoSegment } from "@yingce/lib/canvas/canvas-video-segment";
...
import { storeGeneratedVideo } from "@yingce/services/api/video";
import { getTool } from "@yingce/services/api/tools";
import { getMediaBlob, uploadMediaFile } from "@yingce/services/file-storage";
import { getImageBlob, uploadImage } from "@yingce/services/image-storage";
...
import { defaultConfig, resolveModelRequestConfig, useConfigStore, useEffectiveConfig, type AiConfig } from "@yingce/stores/use-config-store";
import { CanvasNodeType, type CanvasConnection, type CanvasNodeData, type ContextMenuState } from "@yingce/types/canvas";
