...
import { WorkspaceLoadingState, WorkspaceState } from "@yingce/components/layout/workspace-state";

import { readZip } from "@yingce/lib/zip";
import { setMediaBlob } from "@yingce/services/file-storage";
import { setImageBlob } from "@yingce/services/image-storage";
import { CanvasFolderCard } from "@yingce/components/canvas/canvas-folder-card";
import { CanvasHistoryDrawer } from "@yingce/components/canvas/canvas-history-drawer";
import type { CanvasExportFile } from "@yingce/types/canvas-export";
...
import { saveCanvasDrawing, type CanvasDrawingRenderDraft } from "@yingce/lib/canvas/canvas-drawing-storage";
import { createCanvasProjectWithRemoteSync, hasRemoteUserDataSyncSession, loadCanvasProjectForEditing, saveRemoteUserDataNow, scheduleRemoteUserDataSync } from "@yingce/services/user-data-sync";
import { listRemoteCanvasProjectsPage, type CanvasLibrarySummary } from "@yingce/services/api/user-data";
import { useUserStore } from "@yingce/stores/use-user-store";
import { listProjects } from "@yingce/services/api/projects";
import { loadCanvasProjectPage } from "@yingce/lib/workspace-route-modules";
import { resourceFileUrl, resourceStorageKey, uploadResourceFile } from "@yingce/services/api/resources";
import { primeResourceBlobCache } from "@yingce/services/resource-blob-cache";
...
const CanvasDeleteProjectsDialog = lazy(() => import("@yingce/components/canvas/canvas-delete-projects-dialog").then((module) => ({ default: module.CanvasDeleteProjectsDialog })));
