...
import { buildNodeGenerationContext, hydrateNodeGenerationContext } from "@yingce/components/canvas/canvas-node-generation";
import type { CanvasNodeGenerationMode } from "@yingce/components/canvas/canvas-node-prompt-panel";
import { buildGenerationConfig, isGenerationCanceled } from "@yingce/lib/canvas/canvas-project-generation";
import { canvasGenerationPromptMetadata, canvasGenerationRequestFingerprint, runCanvasGenerationSubmissionOnce } from "@yingce/lib/canvas/canvas-generation-submission";
import { isGenerationTaskCapacityError } from "@yingce/lib/canvas/canvas-generation-batch";
import { buildPortraitTexturePrompt } from "@yingce/lib/canvas/canvas-portrait-texture";
import { buildCameraPrompt } from "@yingce/lib/canvas/camera-prompt-library";
import { buildTextRewritePrompt } from "@yingce/lib/prompts";
import { resolveCanvasStyleExecution } from "@yingce/lib/canvas/canvas-style-execution";
import { generationErrorMessage, generationFailureMetadata } from "@yingce/lib/generation-error";
import { modelCompatibilityError, modelGroupReferenceLimits, modelPromptLengthError, modelRequestOptions, type ModelRequirements } from "@yingce/lib/model-selection";
...
import { CanvasNodeType, type CanvasConnection, type CanvasNodeData } from "@yingce/types/canvas";
