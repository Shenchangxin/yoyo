...
import type { CanvasStylePreset } from "@yingce/components/canvas/canvas-style-picker-modal";
import { createCanvasNode } from "@yingce/lib/canvas/canvas-project-domain";
import { createStyleProfileSnapshot, serializeStyleProfile } from "@yingce/lib/canvas/style-profile";
import { updateProject as updateDomainProject } from "@yingce/services/api/projects";
import { CanvasNodeType, type CanvasNodeData, type CanvasNodeMetadata, type Position } from "@yingce/types/canvas";
