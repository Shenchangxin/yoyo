...
import { fallbackSkillCategories } from "@yingce/pages/skills/skill-catalog";
import { generateSkillDraft } from "@yingce/lib/canvas/skill-drafting";
...
import { createSkill, updateSkill, type Skill, type SkillMutationInput, type SkillShowcaseMedia } from "@yingce/services/api/skills";
