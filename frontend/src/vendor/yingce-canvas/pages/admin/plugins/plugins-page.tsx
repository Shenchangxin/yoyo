...
import { ZHIFUFM_LOGO_SRC } from "@yingce/components/payment-brand-icons";
import type { ColumnsType } from "antd/es/table";
import { CloudUpload, PlugZap, RefreshCw, Search, Trash2, UsersRound } from "lucide-react";
import { useEffect, useMemo, useState } from "react";

import { PaginationBar } from "@yingce/pages/admin/components/admin-ui";
...
import type { PluginManifest, PluginManifestV2 } from "@yingce/lib/plugins/plugin-types";
import { fetchAdminPlugins, setPluginPlatformAvailability, uninstallPlugin, uploadPlugin, type AdminPluginState, type BackendPlugin, type PluginManagement } from "@yingce/services/api/plugins";
import { UploadPluginModal } from "@yingce/pages/plugins/plugin-documentation-modals";
