...
import { agentLessonCategoryLabel, deleteAdminAgentLesson, listAdminAgentLessons, type AdminAgentLesson } from "@yingce/services/api/admin-agent-lessons";
import { listAdminUsers, type AdminUser } from "@yingce/services/api/auth";
