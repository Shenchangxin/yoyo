...
import { modelProtocolDefinition, modelProtocolLabel, type ModelProtocol } from "@yingce/lib/model-protocols";
import { fetchPluginProviderCatalog } from "@yingce/services/api/plugin-catalog";
import { deleteAdminChannelModel, deleteAdminChannelModels, fetchAdminChannelModels, importAdminChannelModels, listAdminChannelModels, type ChannelModel } from "@yingce/services/api/wallet";
...
export function ChannelModelManager({ channel, onChanged }: { channel: ModelChannel; onChanged: () => void | Promise<void> }) {
    ...
    const [availableProtocols, setAvailableProtocols] = useState<import("@yingce/lib/model-protocols").ModelProtocolDefinition[]>([]);
