...
} from "@yingce/lib/announcements/banner-notice";
import { bannerAnnouncementBarStyle } from "@yingce/components/layout/banner-announcement-content";
import { BANNER_TITLE_MAX_CHARS, bannerTitleCharCount, bannerTitlePlainText, normalizeBannerTitleRuns, type BannerTitleRun } from "@yingce/lib/announcements/banner-title";
