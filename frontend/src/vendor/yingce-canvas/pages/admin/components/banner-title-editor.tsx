...
} from "@yingce/components/layout/banner-announcement-content";
import { readBannerNoticeSurface, bannerNoticeTypeLabel } from "@yingce/lib/announcements/banner-notice";
...
import {
    ...
    type BannerTitleRun,
} from "@yingce/lib/announcements/banner-title";
import {
...
} from "@yingce/lib/announcements/banner-title-rich-text";
