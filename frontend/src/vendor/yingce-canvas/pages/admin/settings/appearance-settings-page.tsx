...
import { Switch } from "@yingce/pages/admin/ui/controls";
...
import { AdminPageFrame } from "@yingce/pages/admin/components/admin-shell";
import { AdminStatusBadge, SettingsSectionCard } from "@yingce/pages/admin/components/admin-ui";
import { cn } from "@yingce/lib/utils";
import { cloneSkinDefinition, DEFAULT_CLASSIC_SKIN, duplicateSkinDefinition, isSkinButtonFill, normalizeSkinDefinition, type SkinDefinition } from "@yingce/lib/skin-themes";
import { SkinThemeEditor } from "@yingce/pages/admin/settings/components/skin-theme-editor";
import { WelcomeSetting } from "@yingce/pages/admin/settings/components/welcome-setting";
import { CanvasAppearanceEditor } from "./components/canvas-appearance-editor";
import { DEFAULT_CANVAS_APPEARANCE, type CanvasAppearance } from "@yingce/lib/canvas/agent-appearance";
import { deleteAdminResources } from "@yingce/services/api/admin-storage";
import { getAdminAppearance, resetAdminAppearance, updateAdminAppearance, uploadAppearanceAsset, type AdminAppearance, type AppearanceAssetSlot } from "@yingce/services/api/appearance";
import { commitPublicAppearance, DEFAULT_PUBLIC_APPEARANCE } from "@yingce/stores/use-appearance-store";
        ...
        modal.confirm({
            ...
            onOk: async () => {
                ...
                try {
                    ...
                    message.success("已恢复 Yoyo 默认品牌标识");
                } catch (error) {
