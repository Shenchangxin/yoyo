...
import { IconButton, SegmentedControl, Select, Tooltip } from "@yingce/pages/admin/ui/controls";
import { Check, Copy, LockKeyhole, Moon, Plus, Sparkles, Sun, Trash2 } from "lucide-react";
import { useMemo, useState } from "react";

import { SKIN_COLOR_GROUPS, SKIN_COMPONENT_NUMBER_FIELDS, SKIN_BUTTON_COLOR_FIELDS, getSkinButtonAppearance, skinSwatches, type SkinButtonFill, type SkinComponentTokens, type SkinDefinition, type SkinModeTokens, type SkinThemeMode } from "@yingce/lib/skin-themes";
import { cn } from "@yingce/lib/utils";
import { AdminStatusBadge } from "@yingce/pages/admin/components/admin-ui";
