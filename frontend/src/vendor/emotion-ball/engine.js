  ...
  Engine.prototype = {
    ...
    _compose: function (now, depth) {
      ...
      for (var i = 0; i < def.anims.length; i++) {
        ...
        if (this._gazeHeld && anim.target === 'eyes' && (anim.prop === 'lookX' || anim.prop === 'lookY')) continue;
      ...
      if (this._active && def.antics && now >= this._anticNext) {
        ...
        this._anticNext = now + rand(4500, 10000);
      }
